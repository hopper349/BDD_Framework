   ...
   public static class WebDriverExtensions
    {
        ...
        public static IWebElement FindByXpath(this RemoteWebDriver remoteWebDriver, string element)
        {
            try
            {
                ...
                {
                    return remoteWebDriver.FindByXpath(element);
                }
            }
            catch (Exception e)
            {
        ...
        public static IList<IWebElement> FindByList(this RemoteWebDriver remoteWebDriver, string element)
        {
            try
            {
                if (remoteWebDriver.FindElementByLinkText(element).IsElementPresent())
                {
                    return remoteWebDriver.FindElementsByXPath(element);
                }
            }
            catch (Exception e)
            {
